...
nextToken +=   "\tdef Reject(self, stateName):\n"
nextToken +=   "\t\tif(self.debugReject):\n"
nextToken +=   "\t\t\tprint(\"REJECT with token #\"+str(self.currentTokenNumber)"
nextToken +=   "+\":\"+self.currentToken.getValue()+\" @\"+stateName+\"\\n\")\n"
nextToken +=   "\t\telse:\n"
nextToken +=   "\t\t\tprint(\"REJECT\")\n"
nextToken +=   "\t\tsys.exit(1)\n"
#	State Machine
#	Type Specs
